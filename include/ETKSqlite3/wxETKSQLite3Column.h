...
class wxETKSQLite3ValueBindBase;
 ...
 *          Revision : <b>1.0</b>
 */
class EXPORT_IMPORT wxETKSQLite3ColumnAttributes
{
private:
    typedef wxETKSQLite3::shared_ptr<wxETKSQLite3ValueBindBase> tdwxETKSQLite3ValueBindBasePtr;
     ...
     */
    tdwxETKSQLite3ValueBindBasePtr      m_pBindValue;
...
public:
     ...
     */
    wxETKSQLite3ColumnAttributes(const wxETKSQLite3ValueBind & _rBindValue,bool _bAddForInsertRequest = true);
     ...
     */
    wxETKSQLite3ColumnAttributes(const wxETKSQLite3ColumnAttributes &_rColumnAttributes);

    /**
     * Destructor.
     */
    virtual ~wxETKSQLite3ColumnAttributes();
    //@}
     ...
     * @return This.
     */
    const wxETKSQLite3ColumnAttributes &operator=(const wxETKSQLite3ColumnAttributes &_rColumnAttributes);
    //@}
    ...
    friend class wxETKSQLite3Column;
};
 ...
 *          Revision : <b>1.0</b>
 */
class EXPORT_IMPORT wxETKSQLite3Column
{
private:
    /**
     * Table name.
     ...
     */
    wxETKSQLite3ColumnAttributes        m_ColumnAttributes;

    /**
     * Column index.
     *
     * Be careful, Used ONLY on wxETKSQLite3ResultSet to bind column directly on result index.
     * Is -1 if not used.
     */
    int                                 m_iColumnIndex;
public:
     ...
     */
    explicit wxETKSQLite3Column(int _iIndexColumn);
     ...
     */
    wxETKSQLite3Column(wxString _strTableName,wxString _strColumnName);
     ...
     */
    wxETKSQLite3Column(const wxETKSQLite3Column &_rColumn,const wxETKSQLite3ColumnAttributes &_rColumnAttributes);
     ...
     */
    wxETKSQLite3Column(const wxETKSQLite3Column &_rColumn);

    /**
     * Destructor.
     */
    virtual ~wxETKSQLite3Column();
    //@}
     ...
     * wxETKSQLite3Record column non static instance (so binded on real value).
     *
     * @return The column attribute.
     */
    const wxETKSQLite3ColumnAttributes &GetColumnAttributes() const;
     ...
     * @return The column attribute.
     */
    const wxETKSQLite3ColumnAttributes &operator*() const;
     ...
     *
     * Only columns of wxETKSQLite3Record (automatically generated) contains value binding, static columns of
     * wxETKSQLite3Record does not contains the value binding.
     *
     ...
     * @return this.
     */
    const wxETKSQLite3Column &          operator=(const wxETKSQLite3Column &_rColumn);
    //@}
     ...
     * Example:<br>
     * <pre>
     *     wxETKSQLite3RequestSelector selector = GetDatabase().GetSelector();
     ...
     * @return A new formatted expression.
     */
    wxETKSQLite3Expression              Join(const wxETKSQLite3Column &_rColumn) const;
     ...
     * @return A new formatted expression.
     */
    wxETKSQLite3Expression              LeftJoin(const wxETKSQLite3Column &_rColumn) const;
     ...
     * @return A new formatted expression.
     */
    wxETKSQLite3Expression              InnerJoin(const wxETKSQLite3Column &_rColumn) const;
...
//     * @return A new formatted expression.
//     *
//    wxETKSQLite3Expression              RightJoin(const wxETKSQLite3Column &_rColumn) const;
//
//    **
//     * Test equality between column (database right join).
//     *
...
//     * @return A new formatted expression.
//     *
//    wxETKSQLite3Expression              FullJoin(const wxETKSQLite3Column &_rColumn) const;
     ...
     * @return A new formatted expression.
     */
    wxETKSQLite3Expression              In(const wxETKSQLite3RequestSelector &_rSelector) const;
     ...
     *
     * @see ChangeAs,wxETKSQLite3Record::As
     ...
     * @return A new formatted expression.
     */
    wxETKSQLite3Expression              As(wxString _strTableName,wxString _strAsName = wxEmptyString) const;
     ...
     * Unlike the \ref wxETKSQLite3Column::As "As" function, this function doesn't change the table name,
     * only change the columns names.<br>
     * <b>DO NOT CALL THIS FUNCTION ON STATIC COLUMN WITHOUT ATTRIBUTES</b>.
     *
     * @see As,wxETKSQLite3Record::ChangeAs
     * @param _strAsName Name of the AS value variable, if empty, this value is computed as <i>_strTableName</i> + <i>column name</i>.
    ...
    /**
     * Compute the column / table name for the \ref wxETKSQLite3Column::ChangeAs "ChangeAs" function.
     *
     ...
     */
    wxETKSQLite3Column                  ComputeColumnChangeAs(wxString _strTableName,wxString _strAsName = wxEmptyString) const;
     ...
     * @return A new formatted expression.
     */
    wxETKSQLite3Expression              IsNull() const;
     ...
     * @return A new formatted expression.
     */
    wxETKSQLite3Expression              IsNotNull() const;
