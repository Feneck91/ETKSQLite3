...
/////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDE_WX_ETK_SQLITE3_REQUEST_H
#define INCLUDE_WX_ETK_SQLITE3_REQUEST_H

#include "wxETKSQLite3Types.h"
#include "wxETKSQLite3Criterion.h"

class wxETKSQLite3Database;
 ...
 *          Revision : <b>1.0</b>
 */
class EXPORT_IMPORT wxETKSQLite3Request
{
private:
    /**
     * Reference on database.
     */
    wxETKSQLite3Database &              m_rDatabase;
     ...
     */
    wxETKSQLite3Criterion               m_criterionRequest;
...
protected:
     ...
     */
    wxETKSQLite3Request(wxETKSQLite3Database & _rDatabase);
     ...
     */
    wxETKSQLite3Request(const wxETKSQLite3Request & _rOther);

public:
    /**
     * Destructor.
     */
    virtual ~wxETKSQLite3Request();
    //@}
     ...
     */
    int                                 ExecuteWithoutTransaction(bool _bLogError = true,bool _bDisplayMsgBox = true) throw(wxSQLite3Exception);
     ...
     */
    const wxETKSQLite3Criterion &       GetCriterionRequest() const;
     ...
     */
    wxETKSQLite3Criterion &             GetCriterionRequest();
     ...
     */
    void                                Where(const wxETKSQLite3Expression &_rExprWhere);
     ...
     */
    const wxETKSQLite3Expression &      GetWhere();
     ...
     */
    void                                Join(const wxETKSQLite3Expression &_rExprJoin);
...
protected:
     ...
     * must be protected by try / catch statement.
     */
    virtual int                         Execute(bool _bLogError,bool _bDisplayMsgBox,bool _bWithTransaction) throw(wxSQLite3Exception);
     ...
     */
    wxETKSQLite3Database &              GetDatabase() const;
...
#endif // INCLUDE_WX_ETK_SQLITE3_REQUEST_H
