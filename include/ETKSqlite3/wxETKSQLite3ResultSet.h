...
/////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDE_WX_ETK_SQLITE3_RESULTSET_H
#define INCLUDE_WX_ETK_SQLITE3_RESULTSET_H
 ...
 *          Revision : <b>1.0</b>
 */
template <class TYPE> class wxETKSQLite3ResultSet : public wxETKSQLite3ResultSetBase
                                                  , public TYPE
{
public:
     ...
     * Default constructor.
     */
    wxETKSQLite3ResultSet();

    /**
     * Default destructor.
     */
    virtual ~wxETKSQLite3ResultSet();
     ...
     */
    wxETKSQLite3ResultSet(const wxETKSQLite3ResultSet<TYPE>& _rResultSet);
     ...
     *  @param _rResultSet Object to copy from.
     */
    wxETKSQLite3ResultSet(const wxSQLite3ResultSet & _rResultSet);
    //@}
     ...
     * @param _rResultSet Object to copy from.
     */
    const wxETKSQLite3ResultSet<TYPE> & operator=(const wxETKSQLite3ResultSet<TYPE>& _rResultSet);
     ...
     * @param _rResultSet Object to copy from.
     */
    const wxETKSQLite3ResultSet<TYPE> & operator=(const wxSQLite3ResultSet &_rResultSet);
    //@}

    /**
     * Add new binding with column.
     *
     * Be careful, should be called only in wxETKSQLite3Record instance.
     *
     * Example:
     * \code
     *    MyCLassRecord2 record2;
     *    wxETKSQLite3ResultSet<MyCLassRecord> resultSet = selector.ExecuteQuery(); // MyCLassRecord is derived from wxETKSQLite3Record
     ...
     */
    void                                AddBind(const wxETKSQLite3Column &_rColumn);
     ...
     *    resultSet.AddBind(_T("MY_TABLE.MY_COLUMN_2"),wxETKSQLite3ValueBindOther<MyClass>(&myclassInstance); // !! wxETKSQLite3ValueBindOther<MyClass> MUST BE IMPLEMENTED !!
     * \endcode
     *
     ...
     */
    void                                AddBind(wxString strFullColumname,const wxETKSQLite3ValueBind & _rBindValue);
     ...
     *    resultSet.AddBind(MyCLassRecord2::MY_COLUMN_2,wxETKSQLite3ValueBindOther<MyClass>(&myclassInstance); // !! wxETKSQLite3ValueBindOther<MyClass> MUST BE IMPLEMENTED !!
     * \endcode
     *
     * @param _rColumn Column description.
     * @param _rBindValue Value to bind. Pass your own binded class or only pointer on supported bind value type.
     */
    void                                AddBind(const wxETKSQLite3Column &_rColumn,const wxETKSQLite3ValueBind & _rBindValue);
     ...
     */
    void                                AddBind(const wxETKSQLite3Record &_rRecord);
     ...
     * \code
     *    long lRowCount;
     *    wxETKSQLite3ResultSet<wxETKSQLite3Record> resultSetNbItems;     // Empty resultset, does contains nothing
     *    resultSetNbItems.AddBind(0,wxETKSQLite3ValueBind(&lRowCount));  // Add the bind with result index
     ...
     * @param _rBindValue Value to bind. Pass your own binded class or only pointer on supported bind value type.
     */
    void                                AddBind(int _iIndexColumn,const wxETKSQLite3ValueBind & _rBindValue);
...
template <class TYPE> wxETKSQLite3ResultSet<TYPE>::wxETKSQLite3ResultSet()
...
template <class TYPE> wxETKSQLite3ResultSet<TYPE>::wxETKSQLite3ResultSet(const wxETKSQLite3ResultSet<TYPE>& _rResultSet)
    : wxETKSQLite3ResultSetBase(_rResultSet)
{
}

template <class TYPE> wxETKSQLite3ResultSet<TYPE>::wxETKSQLite3ResultSet(const wxSQLite3ResultSet & _rResultSet)
    : wxETKSQLite3ResultSetBase(_rResultSet)
{
}

template <class TYPE> const wxETKSQLite3ResultSet<TYPE> & wxETKSQLite3ResultSet<TYPE>::operator=(const wxETKSQLite3ResultSet<TYPE> & _rResultSet)
{
    wxETKSQLite3ResultSetBase::operator=(_rResultSet);
    return *this;
}

template <class TYPE> const wxETKSQLite3ResultSet<TYPE> & wxETKSQLite3ResultSet<TYPE>::operator=(const wxSQLite3ResultSet &_rResultSet)
{
    wxETKSQLite3ResultSetBase::operator=(_rResultSet);
    return *this;
}

template <class TYPE> void wxETKSQLite3ResultSet<TYPE>::AddBind(const wxETKSQLite3Column &_rColumn)
{
    // Create new column from these informations
    wxASSERT_MSG(_rColumn.IsBindedValueExists(),wxT("No binded value for column into wxETKSQLite3ResultSet<TYPE>::AddBind function.\nDo you forget to call operator [] on record and give only static column?"));
    TYPE::AddColumn(_rColumn);
}

template <class TYPE> void wxETKSQLite3ResultSet<TYPE>::AddBind(wxString strFullColumname,const wxETKSQLite3ValueBind & _rBindValue)
{
    int iFindIndex = strFullColumname.Find(_T('.'));
    if (iFindIndex != wxNOT_FOUND)
    {   // Create new column from these informations
        TYPE::AddColumn(wxETKSQLite3Column(wxETKSQLite3Column(strFullColumname.Left(iFindIndex),strFullColumname.Right(strFullColumname.Len() - iFindIndex -1)),wxETKSQLite3ColumnAttributes(_rBindValue)));
    }
    else
    {   // Else add a column without table name (in case using AS)
        TYPE::AddColumn(wxETKSQLite3Column(wxETKSQLite3Column(_T(""),strFullColumname),wxETKSQLite3ColumnAttributes(_rBindValue)));
    }
}

template <class TYPE> void wxETKSQLite3ResultSet<TYPE>::AddBind(const wxETKSQLite3Column &_rColumn,const wxETKSQLite3ValueBind & _rBindValue)
{
    // Create new column from these informations
    TYPE::AddColumn(wxETKSQLite3Column(_rColumn,wxETKSQLite3ColumnAttributes(_rBindValue)));
}

template <class TYPE> void wxETKSQLite3ResultSet<TYPE>::AddBind(const wxETKSQLite3Record &_rRecord)
{
...
template <class TYPE> void wxETKSQLite3ResultSet<TYPE>::AddBind(int _iIndexColumn,const wxETKSQLite3ValueBind & _rBindValue)
{
    // Create new column from these informations
    TYPE::AddColumn(wxETKSQLite3Column(wxETKSQLite3Column(_iIndexColumn),wxETKSQLite3ColumnAttributes(_rBindValue)));
}

template <class TYPE> const typename TYPE::tdTypeStruct & wxETKSQLite3ResultSet<TYPE>::GetResultDataStruct() const
{
    return *this;
}

template <class TYPE> bool wxETKSQLite3ResultSet<TYPE>::BindFrom()
{
    bool bRet = true;
...
template <class TYPE> bool wxETKSQLite3ResultSet<TYPE>::InitBindFrom()
{
...
#endif // INCLUDE_WX_ETK_SQLITE3_RESULTSET_H
