...
/////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDE_WX_ETK_SQLITE3_DATABASE_H
#define INCLUDE_WX_ETK_SQLITE3_DATABASE_H
...
\section intro What is wxETKSQLite3?
    ...
    Since version 1.1, \b wxETKSQLite3 allowed to be used with \b QT library. All needed \b wxWidgets classes are re-written around  \b QT
    library classes (based on macros or directly by implementing these \b wxWidgets classes by deriving \b QT ones).
    <br><br><b>Be careful, the QT workaround is not done to use wxWidgets classes instead of QT classes. All wxWidgets classes has been tested with wxETKSQLite3 but are not
    been implements to be use instead of QT classes. Implementing a software based on wxETKSQLite3 library must use all QT classes.</b>
...
\section ackn Acknowledgements
    ...
    Kudos to <b>Ulrich Telle</b> (and all the peaple have contributed to \b wxSQLite3) for developing \b wxSQLite3 based library used by \b wxETKSQLite3.
...
/** \page Installation Getting started: installation
    ...
    This page will explain how to compile wxETKSQLite3 with \b Code::Blocks or with <b>Microsoft Visual Studio</b> IDE.<br>
    <br>
    ...
    <br>
    You can compile \b wxETKSQLite3 in differents way :
    <ul>
...
/** \page Installation_wx Installation wxWidgets Based
    ...
    To make \b wxETKSQLite3 works with \b wxWidgets library first you need to compile \b wxWidgets library.
    <br>
...
/** \page Installation_wx_CodeBlocks Installation wxWidgets Based - Code::Blocks IDE
    ...
    <ul>
     ...
     <li> Open project named:
        <ul>
            <li> \b wxWidgets based / <b>Code::Blocks</b> project: <i>wxETKSQLite3/build/wxETKSQLite3.cbp</i></li>
            <li> \b wxWidgets based / <b>Microsoft Visual Studio</b> project: <i>not implemented yet</i></li>
            <li> \b QT based / <b>Code::Blocks</b> project: <i>wxETKSQLite3/build/qtETKSQLite3.cbp</i></li>
            <li> \b QT based / <b>Microsoft Visual Studio</b> project: <i>wxETKSQLite3/build/qtETKSQLite3.vcproj</li>
        </ul>
      <ul>
        <li> Select needed target (Debug / Release / Static or Dynamic library).</li>
        <ul> <b>Code::Blocks</b>
            <li> Build wxETKSQLite3. You need to update global variables into settings:</li>
              <ul>
                <li> <b>wx</b>:
                    <ul>
                ...
                <li> <b>wxetksqlite3</b>: wxETKSQLite3 library root folder (for latter uses).</li>
          </ul>
        </li>
        <li>Your wxETKSQLite3 is now compiled into <i>wxETKSQLite3/lib</i> folder.</li>
    </ul>
*/
...
\section Creating wxETKSQLite3's project based.
    <ul>
      ...
      <li> Into <b>Build Option</b> properties of the project:
        <ul>
          <li><b>Linker settings</b> tab:
            <ul>
              <li>In Debug mode, add \b libwxETKSQLite3d.a for dynamic link library, \b libStaticwxETKSQLite3d.a
                  for static link library.</li>
              <li>In Release mode, add \b libwxETKSQLite3.a for dynamic link library, \b libStaticwxETKSQLite3.a
                  for static link library.</li>
            </ul></li>
      ...
      <li> Into <b>wx_pch.h</b> file (precompiler header):
        ...
        #endif // WX_PRECOMP
        \endcode
        The following line \b MUST be removed if \b wxETKSQLite3 is build as dynamic library.
        \code
            #define USING_WX_ETK_SQLITE3_LIB // <-- MUST be removed if compiling as dynamic library
        \endcode
 ...
 *          Revision : <b>1.1</b>
 */
class EXPORT_IMPORT wxETKSQLite3Database : public wxSQLite3Hook
{
public:
    /**
     ...
     *          Revision : <b>1.0</b>
     */
    struct EXPORT_IMPORT SDatabaseEvent : public wxETKSQLite3::IRefCountImpl<SDatabaseEvent>
    {
        /**
     ...
     */
    typedef wxETKSQLite3::shared_ptr<SDatabaseEvent> tdPtrDatabaseEvent;
...
public:
     ...
     * <ul>
     *  <li> <b>wxETKSQLite3RequestInserter</b>: Used to add rows into table.
     *  <li> <b>wxETKSQLite3RequestUpdater</b>: Used to modify rows into table.
     *  <li> <b></b>
     *  <li> <b></b>
     *  <li>
     * </ul>
     ...
     */
    wxETKSQLite3RequestInserter         GetInserter();
     ...
     */
    wxETKSQLite3RequestUpdater          GetUpdater();
     ...
     * @return A new instance of updater.
     */
    wxETKSQLite3RequestDeleter          GetDeleter();
     ...
     * @return A new instance of updater.
     */
    wxETKSQLite3RequestSelector          GetSelector();
    //@}
...
protected:
     ...
     * @return The number of database rows that were changed (or inserted or deleted), 0 if error.
     */
    int                                 ExecuteStatementWithoutTransaction(wxSQLite3Statement &_rstmRequest,bool _bLogError,bool _bDisplayMsgBox) throw(wxSQLite3Exception);
     ...
     */
    int                                 ExecuteSQLWithTransaction(wxString _strSQL,bool _bLogError,bool _bDisplayMsgBox) throw(wxSQLite3Exception);
     ...
     *                           must be protected by try / catch statement.
     */
    int                                 ExecuteSQLWithoutTransaction(wxString _strSQL,bool _bLogError,bool _bDisplayMsgBox) throw(wxSQLite3Exception);
...
private:
     ...
     * must be protected by try / catch statement.
     */
    wxSQLite3Statement                  PrepareEmptyStatement(wxString _strStatementSQL) throw(wxSQLite3Exception);
     ...
     *                           must be protected by try / catch statement.
     */
    int                                 ExecuteStatement(wxSQLite3Statement &_rstmRequest,bool _bLogError,bool _bDisplayMsgBox,bool _bUseTransaction) throw(wxSQLite3Exception);
     ...
     *                           must be protected by try / catch statement.
     */
    int                                 ExecuteSQL(wxString _strSQL,bool _bLogError,bool _bDisplayMsgBox,bool _bUseTransaction) throw(wxSQLite3Exception);
...
protected:
     ...
     *
     * @throw wxSQLite3Exception If the function failed, a wxSQLite3Exception is raided so calling this function
     *                           must be protected by try / catch statement (already done by the wxETKSQLite3Database class).
     */
     ...
     *                           must be protected by try / catch statement.
     */
    virtual bool                        InitCallbacks() throw(wxSQLite3Exception);
     ...
     *                           must be protected by try / catch statement.
     */
    virtual void                        UnInitCallbacks() throw(wxSQLite3Exception);
...
protected:
    ...
    friend class wxETKSQLite3Request;
    friend class wxETKSQLite3RequestUpdater;
    friend class wxETKSQLite3RequestInserter;
    friend class wxETKSQLite3RequestDeleter;
    friend class wxETKSQLite3RequestSelector;
};

#endif // INCLUDE_WX_ETK_SQLITE3_DATABASE_H
