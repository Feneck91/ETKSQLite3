...
/////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDE_WX_ETK_SQLITE3_RECORD_H
#define INCLUDE_WX_ETK_SQLITE3_RECORD_H
 ...
 *          Revision : <b>1.0</b>
 */
class EXPORT_IMPORT wxETKSQLite3Record
{
private:
    /**
     * Type of column list, with vector, faster access than list.
     */
    typedef std::vector<wxETKSQLite3Column> tdListColumns;
...
public:
     ...
     *
     * Only use to create an empty ResultSet as "wxETKSQLite3ResultSet<wxETKSQLite3Record>" instance.
     */
    typedef wxETKSQLite3Record tdTypeStruct;
...
public:
     ...
     */
    wxETKSQLite3Record(wxString _strTableName);

    /**
     * Destructor.
     */
    virtual ~wxETKSQLite3Record();
    //@}
     ...
     */
    static wxETKSQLite3Column           GetAllColumn(wxString _strTableName);
     ...
     */
    void                                AddColumn(const wxETKSQLite3Column &_rColumn);
     ...
     */
    const wxETKSQLite3Record &          MergeRecord(const wxETKSQLite3Record &_rRecord);
     ...
     * @return A reference to this.
     */
    const wxETKSQLite3Record &          ChangeTableName(wxString _strTableName);
     ...
     *
     * @see ChangeAs,wxETKSQLite3Column::As
     * @param _strTableName New table name.
     * @return A generated expression.
     */
    wxETKSQLite3Expression              As(wxString _strTableName) const;
     ...
     * that use the <b>AS</b> expression from the record. Will call \ref wxETKSQLite3Column::ChangeAs "ChangeAs"
     * on each column.
     *
     * When using the \ref wxETKSQLite3Column::As "As" function on column you can choose the as value, in the case of using on record
     * you cannot choose this value, it is also automatically computed by concatenate the new table name
     * with the column name for each columns.
     *
     * @see As,wxETKSQLite3Column::ChangeAs
     ...
     */
    const wxETKSQLite3Column &          GetColumn(size_t _nIndex) const;
     ...
     */
    const wxETKSQLite3Column *          FindColumnByName(wxString _strColumnName) const;
     ...
     * @return A const pointer of column, NULL if nnot found.
     */
    const wxETKSQLite3Column *          FindColumnByFullName(wxString _strColumnFullName) const;
     ...
     */
    const wxETKSQLite3Column &          operator[](const wxETKSQLite3Column &_rColumn) const throw(wxSQLite3Exception);
     ...
     * @return A column information corresponding to this index.
     */
    const wxETKSQLite3ColumnAttributes &GetColumnAttributes(int _Index) const;
...
private:
     ...
     */
    const wxETKSQLite3Record & operator=(const wxETKSQLite3Record &_rRecord);
};

#endif // INCLUDE_WX_ETK_SQLITE3_RECORD_H
