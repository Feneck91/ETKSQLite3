...
const etkString $PREFIX_TABLE$$TABLE_NAME$::STR_TABLE_CONSTRUCTION_INDEX =
    _T(
        "$SQL_TABLE_INDEX_CONSTRUCTION$"
      );
...
etkString $PREFIX_TABLE$$TABLE_NAME$::GetSQLTableIndexConstruction()
{
    return STR_TABLE_CONSTRUCTION_INDEX;
}
