...
template<> void ETKSQLite3ValueBindOther<int64_t>::BindTo(wxSQLite3Statement &_rstmt,int _iIndex,bool _bAddForInsertRequest, bool _bForInsertRequest) const
{
...
template<> void ETKSQLite3ValueBindOther<etkString>::BindTo(wxSQLite3Statement &_rstmt,int _iIndex,bool _bAddForInsertRequest,bool _bForInsertRequest) const
{
    wxUnusedVar(_bAddForInsertRequest);
    wxUnusedVar(_bForInsertRequest);
    _rstmt.Bind(_iIndex,etkString(*m_pDataPtr));
}
...
template<> void ETKSQLite3ValueBindOther<wxDate>::BindTo(wxSQLite3Statement &_rstmt,int _iIndex,bool _bAddForInsertRequest,bool _bForInsertRequest) const
{
    wxUnusedVar(_bAddForInsertRequest);
    wxUnusedVar(_bForInsertRequest);
...
template<> void ETKSQLite3ValueBindOther<wxTime>::BindTo(wxSQLite3Statement &_rstmt,int _iIndex,bool _bAddForInsertRequest,bool _bForInsertRequest) const
{
    wxUnusedVar(_bAddForInsertRequest);
    wxUnusedVar(_bForInsertRequest);
...
template<> void ETKSQLite3ValueBindOther<wxDateTime>::BindTo(wxSQLite3Statement &_rstmt,int _iIndex,bool _bAddForInsertRequest,bool _bForInsertRequest) const
{
    wxUnusedVar(_bAddForInsertRequest);
    wxUnusedVar(_bForInsertRequest);
